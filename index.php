...
<head>
    ...
    <!-- Rimosso CSS traduzione client-side -->
...
<body class="min-h-screen bg-gray-50 font-sans">
    ...
    <section class="relative bg-gradient-to-br from-blue-900 via-blue-700 to-amber-600 text-white py-24 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
                <?php echo htmlspecialchars($contentManager->getText('hero-title', $heroSection['title'] ?? 'Esplora la Calabria')); ?>
            </h1>
            <p class="text-xl md:text-2xl text-yellow-400 mb-8">
                <?php echo htmlspecialchars($contentManager->getText('hero-subtitle', $heroSection['subtitle'] ?? 'Mare cristallino e storia millenaria')); ?>
            </p>
            <p class="text-lg md:text-xl text-gray-200 mb-12 max-w-3xl mx-auto">
                <?php echo htmlspecialchars($contentManager->getText('hero-description', $heroSection['description'] ?? 'Immergiti nella bellezza della Calabria, con le sue spiagge da sogno, il centro storico affascinante e i panorami mozzafiato dalla rupe.')); ?>
            </p>
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4 mb-16">
                <a href="categorie.php" class="inline-flex items-center px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-semibold transition-colors">
                    ...
                    <span><?php echo htmlspecialchars($contentManager->getText('discover-calabria-btn', 'Scopri la Calabria')); ?></span>
                </a>
                <a href="mappa.php" class="inline-flex items-center px-8 py-4 bg-transparent border-2 border-white hover:bg-white hover:text-gray-800 text-white rounded-full font-semibold transition-colors">
                    ...
                    <span><?php echo htmlspecialchars($contentManager->getText('view-map-btn', 'Visualizza Mappa')); ?></span>
                </a>
            </div>

            <!-- Search Widget -->
            <div class="max-w-4xl mx-auto bg-white rounded-2xl p-8 shadow-2xl">
                <h2 class="text-2xl font-bold text-gray-800 mb-6"><?php echo htmlspecialchars($contentManager->getText('search-what', 'Cosa stai cercando?')); ?></h2>
                <form action="ricerca.php" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo htmlspecialchars($contentManager->getText('search-label', 'Luoghi, eventi, tradizioni...')); ?></label>
                        <input
                            type="text"
                            name="q"
                            placeholder="<?php echo htmlspecialchars($contentManager->getText('search-placeholder', 'Inserisci quello che vuoi esplorare')); ?>"
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo htmlspecialchars($contentManager->getText('province-label', 'Provincia')); ?></label>
                    ...
                    <div class="flex items-end">
                        <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center">
                            <i data-lucide="search" class="w-5 h-5 mr-2"></i>
                            <span><?php echo htmlspecialchars($contentManager->getText('search-btn', 'Cerca')); ?></span>
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">
                    <?php echo htmlspecialchars($contentManager->getText('events-app', $settingsArray['events_title'] ?? 'Eventi e App')); ?>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    <?php echo htmlspecialchars($contentManager->getText('app-description', $settingsArray['events_description'] ?? 'Scarica la nostra app per rimanere sempre aggiornato sugli eventi in Calabria.')); ?>
                </p>
            </div>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row justify-center items-center gap-8 mb-12">
                    ...
                    <a href="<?php echo htmlspecialchars($eventData['app_store_link']); ?>" target="_blank" class="transition-transform hover:scale-105">
                        <img src="<?php echo htmlspecialchars($eventData['app_store_image']); ?>" alt="<?php echo htmlspecialchars($contentManager->getText('download-app-store', 'Scarica su App Store')); ?>" class="h-14 w-auto">
                    </a>
                    <?php endif; ?>
                    ...
                    <a href="<?php echo htmlspecialchars($eventData['play_store_link']); ?>" target="_blank" class="transition-transform hover:scale-105">
                        <img src="<?php echo htmlspecialchars($eventData['play_store_image']); ?>" alt="<?php echo htmlspecialchars($contentManager->getText('download-google-play', 'Scarica su Google Play')); ?>" class="h-14 w-auto"
                    </a>
                    <?php endif; ?>
                </div>
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    <a href="<?php echo htmlspecialchars($eventData['vai_app_link']); ?>" target="_blank" class="inline-flex items-center justify-center px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-semibold transition-colors">
                        ...
                        <span><?php echo htmlspecialchars($contentManager->getText('go-to-app', 'Vai all\'App')); ?></span>
                    </a>
                    <?php endif; ?>
                    ...
                    <a href="<?php echo htmlspecialchars($eventData['suggerisci_evento_link'] ?? 'suggerisci-evento.php'); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-amber-500 hover:bg-amber-600 text-white rounded-full font-semibold transition-colors">
                        ...
                        <span><?php echo htmlspecialchars($contentManager->getText('suggest-event', 'Suggerisci Evento')); ?></span>
                    </a>
                </div>
                ...
                <div class="text-center mt-8">
                    <p class="text-gray-600">
                        <?php echo htmlspecialchars($contentManager->getText('suggest-event-description', 'Hai un evento da condividere? Segnalacelo e lo valuteremo per includerlo nella nostra piattaforma.')); ?>
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">
                    <?php echo htmlspecialchars($contentManager->getText('explore-by-category', $settingsArray['categories_title'] ?? 'Esplora per Categoria')); ?>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    <?php echo htmlspecialchars($contentManager->getText('category-description', $settingsArray['categories_description'] ?? 'Scopri la Calabria attraverso le sue diverse sfaccettature: dalla natura incontaminata alla ricca tradizione culturale.')); ?>
                </p>
            </div>
                    ...
                    <div class="bg-gradient-to-br from-blue-500 to-teal-600 relative overflow-hidden p-6">
                        <div class="flex justify-between items-start mb-4">
                            <div class="bg-white/20 backdrop-blur-sm text-white px-3 py-1 rounded-full text-sm font-medium">
                                <span><?php echo $category['article_count']; ?> <?php echo htmlspecialchars($contentManager->getText('articles-count', 'articoli')); ?></span>
                            </div>
                            <div class="text-4xl"><?php echo $category['icon']; ?></div>
                        </div>
                        <h3 class="text-2xl font-bold text-white mb-2"><?php echo htmlspecialchars($contentManager->getText('category-name-'.$category['id'], $category['name'])); ?></h3>
                        <p class="text-blue-100 text-sm"><?php echo htmlspecialchars($contentManager->getText('category-desc-'.$category['id'], $category['description'])); ?></p>
                    </div>
                                            ...
                                            <div class="flex items-start space-x-3 p-2 rounded-lg hover:bg-gray-50 transition-colors">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <h4 class="text-sm font-semibold text-gray-900 group-hover/article:text-blue-600 transition-colors line-clamp-2 leading-tight">
                                                        <?php echo htmlspecialchars($contentManager->getText('article-title-'.$article['id'], $article['title'])); ?>
                                                    </h4>
                        ...
                        <div class="border-t pt-4">
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-500 flex items-center">
                                    ...
                                    <?php echo $category['article_count']; ?> <span class="translatable" data-translate="contents">contenuti</span>
                                </span>
            ...
            <div class="text-center mt-16">
                <a href="categorie.php" class="inline-flex items-center px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-semibold transition-colors">
                    <span class="translatable" data-translate="see-all-categories"><?php echo htmlspecialchars($settingsArray['categories_button_text'] ?? 'Vedi Tutte le Categorie'); ?></span> <i data-lucide="arrow-right" class="w-5 h-5 ml-2"></i>
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">
                    <?php echo htmlspecialchars($contentManager->getText('provinces-title', $settingsArray['provinces_title'] ?? 'Esplora le Province')); ?>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    <?php echo htmlspecialchars($contentManager->getText('provinces-description', $settingsArray['provinces_description'] ?? 'Ogni provincia calabrese custodisce tesori unici: dalla costa tirrenica a quella ionica, dai monti della Sila all\'Aspromonte.')); ?>
                </p>
            </div>
                    ...
                    <div class="aspect-[4/3] relative overflow-hidden">
                        ...
                        <div class="absolute top-4 right-4">
                            <span class="bg-white/20 backdrop-blur-sm text-white px-3 py-1 rounded-full text-sm shadow-lg">
                                <?php echo $articleCount; ?> <span class="translatable" data-translate="contents">contenuti</span>
                            </span>
                        </div>
                        ...
                        <div class="absolute bottom-4 left-4">
                            <div class="flex items-center bg-green-500 text-white px-2 py-1 rounded-full text-xs shadow-lg">
                                ...
                                <span class="translatable" data-translate="with-photo">Con foto</span>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="p-6">
                        <h3 class="text-2xl font-bold text-gray-900 mb-2"><?php echo htmlspecialchars($contentManager->getText('province-name-'.$province['id'], $province['name'])); ?></h3>
                        <p class="text-gray-600 mb-4"><?php echo htmlspecialchars($contentManager->getText('province-desc-'.$province['id'], $province['description'])); ?></p>

                        <div class="mb-4">
                            <h4 class="font-semibold text-gray-900 mb-2"><?php echo htmlspecialchars($contentManager->getText('main-locations', 'LOCALITÀ PRINCIPALI:')); ?></h4>
                            <div class="flex flex-wrap gap-2">
                                <?php foreach (array_slice($cities, 0, 3) as $city): ?>
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm translatable" data-translate="city-<?php echo $city['id']; ?>"><?php echo htmlspecialchars($city['name']); ?></span>
                                <?php endforeach; ?>
                            </div>
                        </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">
                    <?php echo htmlspecialchars($contentManager->getText('map-title', $settingsArray['map_title'] ?? 'Esplora la Mappa Interattiva')); ?>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    <?php echo htmlspecialchars($contentManager->getText('map-description', $settingsArray['map_description'] ?? 'Naviga attraverso la Calabria con la nostra mappa interattiva. Scopri luoghi, eventi e punti d\'interesse in tempo reale.')); ?>
                </p>
            </div>
                ...
                <div class="mb-6">
                    <div class="flex items-center space-x-6">
                        ...
                        <label class="flex items-center space-x-2">
                            ...
                            <span class="text-sm">Luoghi di interesse</span>
                        </label>
                        <label class="flex items-center space-x-2">
                            <input type="checkbox" checked class="rounded border-gray-300">
                        ...
                        <label class="flex items-center space-x-2">
                            ...
                            <span class="text-sm">Ristoranti</span>
                        </label>
                        <label class="flex items-center space-x-2">
                            <input type="checkbox" class="rounded border-gray-300">
                            <span class="text-sm">Hotel</span>
                        </label>
                        <div class="ml-auto text-sm text-gray-500">0 luoghi trovati</div>
                    </div>
                </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                <?php echo htmlspecialchars($contentManager->getText('newsletter-description', $settingsArray['newsletter_description'] ?? 'Iscriviti alla nostra newsletter per ricevere i migliori contenuti e non perdere mai gli eventi più interessanti della regione.')); ?>
            </p>
            ...
            <form action="<?php echo htmlspecialchars($settingsArray['newsletter_form_action'] ?? 'api/newsletter.php'); ?>" method="POST" class="max-w-md mx-auto flex gap-4">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-semibold transition-colors">
                    <?php echo htmlspecialchars($contentManager->getText('newsletter-button', $settingsArray['newsletter_button'] ?? 'Iscriviti Gratis')); ?>
                </button>
            </form>
