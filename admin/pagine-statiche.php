        ...
        switch ($_POST['action']) {
            case 'create':
                ...
                if ($success) {
                    ...
                    // 🌍 TRADUZIONE AUTOMATICA: Traduci nuova pagina statica in tutte le lingue supportate
                    try {
                        $pageData = [
                            'title' => $_POST['title'],
                        ...
                        $translationResult = $translationService->translateStaticPage($pageId, $pageData);
                        if ($translationResult) {
                            $message = 'Pagina creata e tradotta automaticamente in tutte le lingue supportate!';
                        } else {
                            $message = 'Pagina creata con successo! Nota: alcune traduzioni potrebbero non essere riuscite.';
                        }
                        $messageType = 'success';
                    } catch (Exception $e) {
                        error_log("Errore traduzione pagina statica $pageId: " . $e->getMessage());
                        $message = 'Pagina creata con successo! Le traduzioni verranno elaborate in background.';
                        $messageType = 'success';
                    }
                } else {
            ...
            case 'update':
                ...
                if ($success) {
                    // 🌍 TRADUZIONE AUTOMATICA: Aggiorna traduzioni pagina statica in tutte le lingue supportate
                    try {
                        $pageData = [
                            'title' => $_POST['title'],
                            'content' => $_POST['content'],
                        ...
                        $translationResult = $translationService->translateStaticPage($_POST['id'], $pageData);
                        if ($translationResult) {
                            $message = 'Pagina aggiornata e ritradotta automaticamente in tutte le lingue supportate!';
                        } else {
                            $message = 'Pagina aggiornata con successo! Nota: alcune traduzioni potrebbero non essere riuscite.';
                        }
                        $messageType = 'success';
                    } catch (Exception $e) {
                        error_log("Errore traduzione pagina statica {$_POST['id']}: " . $e->getMessage());
                        $message = 'Pagina aggiornata con successo! Le traduzioni verranno elaborate in background.';
                        $messageType = 'success';
                    }
                } else {
